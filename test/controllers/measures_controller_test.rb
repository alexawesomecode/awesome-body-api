...
class MeasuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post measures_url, params: { measure: { date: @measure.date, name: @measure.name, value: @measure.value } }, as: :json
    end
  ...
  test "should update measure" do
    patch measure_url(@measure), params: { measure: { date: @measure.date, name: @measure.name, value: @measure.value } }, as: :json
    assert_response 200
  end
